    ...
    return (
      <>
        ...
        <div
          ...
          aria-live="polite"
          tabIndex={-1}
          className="rounded-lg border bg-orange-50 p-6 text-center"
        >
          <h2 className="mb-2 text-lg font-semibold text-orange-900">Sign-ups Temporarily Closed</h2>
  ...
  if (response?.status === "success") {
    return (
      <div className="flex flex-col items-start gap-4">
        {/* eslint-disable jsx-a11y/prefer-tag-over-role -- The focus target is a result region, not a form output value. */}
        <div
          ref={resultRef}
          role="status"
          aria-live="polite"
          tabIndex={-1}
          className="w-full rounded-lg border border-primary/30 bg-primary/10 p-4"
        >
      ...
      <Form {...form}>
        {response && (
          <div
            ...
            role="alert"
            tabIndex={-1}
            className="mb-8 rounded-lg border border-destructive/30 bg-destructive/10 p-4 text-destructive-text"
          >
